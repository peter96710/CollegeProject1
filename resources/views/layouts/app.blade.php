...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            ...
            @role('tanar')
            <a class="navbar-brand" href="{{ url('/tanar/home') }}">
                {{ __('My Courses') }}
            </a>
            <a class="navbar-brand" href="{{ url('/tanar/newcourse') }}">
                {{ __('New Course') }}
            </a>
            @endrole
            @role('diak')
            <a class="navbar-brand" href="{{ url('/diak/home') }}">
                {{ __('My Courses') }}
            </a>
            <a class="navbar-brand" href="{{ url('/diak/newcourses') }}">
                {{ __('New Courses') }}
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @endguest
                    <a class="navbar-brand" href="{{ url('/kapcsolat') }}"> Contact </a>
                </ul>
            </div>
        </div>
    </nav>
