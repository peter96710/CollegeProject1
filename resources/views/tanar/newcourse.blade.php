            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            <form method="GET" action="newcoursefunction">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="credit" type="number" class="form-control @error('code') is-invalid @enderror" name="credit" required autocomplete="credit" autofocus>
